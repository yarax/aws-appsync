...
var buildMutation = function (client, mutation, variables, cacheUpdateQuery, typename, idField, operationType) {
    ...
    var _c = idField || 'id', idCustomField = variables[_c];
    ...
    return {
        ...
        optimisticResponse: typename ? (_a = {
                __typename: "Mutation"
            },
            _a[mutationField] = __assign((_b = { __typename: typename }, _b[idField] = variables[idField] || uuid_1.v4(), _b), variables, { version: version + 1 }),
            _a) : null,
