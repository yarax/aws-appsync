...
exports.createAppSyncLink = function (_a) {
    ...
    var errorCallback = _a.errorCallback || function() {console.log('No handler for network error', arguments)};
    var errorLink = apolloLinkError.onError(errorCallback);
...
var AWSAppSyncClient = /** @class */ (function (_super) {
    ...
    function AWSAppSyncClient(_a, options) {
        ...
        var link = waitForRehydrationLink.concat(customLink || exports.createAppSyncLink({errorCallback: _a.errorCallback, url: url, region: region, auth: auth, complexObjectsCredentials: complexObjectsCredentials }));
